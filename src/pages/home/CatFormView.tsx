...
function catToFormData(cat: Cat): CatFormData {
	return {
		...
		breedPredisposition: cat.dnaProfile?.breedPredisposition || "",
		coatPattern: cat.dnaProfile?.coatPattern || "",
		eyeColorGene: cat.dnaProfile?.eyeColorGene || "",
		bloodType: cat.dnaProfile?.bloodType || "",
		geneticDiversity: cat.dnaProfile?.geneticDiversity || "",
		inbreedingCoefficient: cat.dnaProfile?.inbreedingCoefficient || "",
